...
namespace R5T.S0061
{
    ...
    public partial interface IValues : IValuesMarker
    {
        ...
        /// </summary>
        public Dictionary<string, string> MethodNameMarkerAttributeNamespacedTypeNamesByInstanceVariety => new()
        {
        ...
        /// </summary>
        public Dictionary<string, string> PropertyNameMarkerAttributeNamespacedTypeNamesByInstanceVariety => new()
        {
        ...
        /// </summary>
        public Dictionary<string, string> InstanceTypeMarkerAttributeNamespacedTypeNamesByVarietyName => new()
        {
